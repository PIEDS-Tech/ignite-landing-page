const siteContent = {
  ...
  venue: {
    ...
    address: 'Venue details to be announced',
    features: ['World-class convention facilities', 'Global connectivity hub', 'Premier hospitality & networking'],
    images: [
      { src: 'https://framerusercontent.com/images/q5CAbxhi8kSJKB38EtQVvO7VQ9w.webp', alt: 'Venue' },
